...
yaml_file = open("c01_q1500_200_150_150_p25_25_25_25.yaml")
...
prefixo = "c" + str(qtde_ciclos_recalcular_modelo) + "__qtde" + np.array2string(APs_qtdes, formatter={'float_kind':lambda x: "%.2f" % x}) + '__prioridade' + np.array2string(APs_prioridades, formatter={'float_kind':lambda x: "%.2f" % x})
...
#print(qtde_vezes_AP_executada)
   ...
   while total_recurso_compartilhado > 100:
      ...
      if qtde_recurso_consumido_ciclo_atual >= qtde_recurso_consumido_para_recalcular_ciclo:
         ...
         print("")
         print("Recálculo após {} APs executadas".format(qtde_acoes_executadas))
